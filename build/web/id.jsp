	...
	<body>
            ...
            <% 
                ...
                try {
                    ...
                    HttpResponse<String> responseAPI = Unirest.get(ClsURL.getUrl()+"api/Messages/id")
                   .header("Content-Type", "application/x-www-form-urlencoded")
                   .queryString("X_Signature", request.getParameter("X_Signature"))
                   .queryString("X_Key", request.getParameter("KeyKey"))
                   .queryString("Id", request.getParameter("Id"))
                   .asString();
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-heading"></div>
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            Message <input class="form-control" type="text" name="Message" value="<%= jsonObj.getString("Message") %>" readonly><br>
                                        </div>
                                        <div class="col-md-6">
                                           Status Code Id <input class="form-control" type="text" name="StatusCode" value="<%=  StatusCode %>" readonly/></br>
                                        </div>                                        
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
		...
		<div class="container">
                <div class="panel panel-primary">
                    <form method="post" action="MessagesIndex.jsp">
                    <div class="panel-heading">Status Code Id</div>
                            <div class="panel-body">
